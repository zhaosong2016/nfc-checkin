                ...
                if msg.get("type")=="manual_checkin":
                    ...
                    if 0<=pid<len(roster):
                        ...
                        if not p["checkedIn"]:
                            ...
                            ev={"type":"checkin","id":p["id"],"name":p["name"],"time":p["time"],"bus":p.get("bus",1),"phone":p.get("phone",""),"source":"manual"}
